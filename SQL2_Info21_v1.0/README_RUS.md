...
В данном проекте создаётся база данных со знаниями о Школе, написаны процедуры и функции для получения информации, а также процедуры и триггеры для её изменения.
...
Скрипт *part1.sql*, создаёт базу данных и все таблицы, описанные выше. 

Также в скрипт внесена процедура, позволяющие импортировать и экспортировать данные для каждой таблицы из файла/в файл с расширением *.csv*. \
...
Скрипт *part2.sql*, в который, внесены все запросы описанные ниже.
...
Скрипт *part3.sql*, в который добавлены описанные далее процедуры и функции.

##### 1) Ффункция, возвращающую таблицу TransferredPoints в более человекочитаемом виде
